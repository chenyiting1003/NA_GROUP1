...
Inside Airbnb collects data to enhance transparency by addressing incomplete and biased reports[@inside_airbnb_about;@alsudais_incorrect_2021]. Studies show that short-term rentals disrupt communities, drive gentrification, and exacerbate housing inequities in cities like New York, London, and Nanjing [@jiao_cities_2020;@wachsmuth_airbnb_2018; @sun_characteristics_2021].
To promote housing equity, Inside Airbnb focuses on:
Increasing Transparency: Highlight the effects of short-term rentals on housing availability and affordability [@inside_airbnb_about; @garcia_ayllon_airbnb_2018].
Supporting Policy Development: Provide actionable data to regulate short-term rentals and tackle urban challenges [@uk_government_2023; @jiao_cities_2020].
